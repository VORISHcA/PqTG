...
def gui_create_model(database):
    ...
    list_table.setHorizontalHeaderLabels(['Имя Клиеета', 'IP Адрес', 'Порт', 'Время подключения'])
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.refresh_button = QAction('Обновть список', self)
        ...
        # Тулбар
        self.toolbar = self.addToolBar('ЬainBar')
